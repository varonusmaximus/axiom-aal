...
Bundled `.cursor/skills/security/core.md` is replaced on `aal upgrade`. Company rules live in:
...
Commit the override file. `aal upgrade` preserves it; inject merges bundled + override.
