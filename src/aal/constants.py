...
DEFAULT_CONFIG = {
    ...
    "inject_log": ".cursor/logs/aal-inject.jsonl",
}
...
CURSOR_CONFIG_DIR = os.environ.get("AAL_CURSOR_DIR", ".cursor")


def cursor_config_dir_name() -> str:
    """Return the project-relative Cursor/AAL config directory name."""
    return os.environ.get("AAL_CURSOR_DIR") or os.environ.get("AXIOMPY_AAL_CURSOR_DIR", ".cursor")


DOMAINS_FILE = "domains.yaml"
AAL_CONFIG_FILE = "aal.yaml"
BOOTSTRAP_FILE = "bootstrap.yaml"
MANIFEST_FILE = ".aal-manifest.json"
LEGACY_MANIFEST_FILE = ".axiompy-manifest.json"
