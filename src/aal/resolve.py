...
from aal.domains import domain_skill_paths, load_domains
from aal.parser import effective_annotation_at_line, parse_aal_file
...
def cmd_resolve(
    ...
    *,
    ...
    from aal.inject_log import append_inject_log
